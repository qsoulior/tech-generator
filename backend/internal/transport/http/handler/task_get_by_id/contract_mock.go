...
//
//	mockgen -package task_get_by_id_handler -source contract.go -destination contract_mock.go
//

// Package task_get_by_id_handler is a generated GoMock package.
...
func (m *Mockusecase) Handle(ctx context.Context, in domain.TaskGetByIDIn) (*domain.TaskGetByIDOut, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Handle", ctx, in)
	ret0, _ := ret[0].(*domain.TaskGetByIDOut)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
