...
//
//	mockgen -package version_list_handler -source contract.go -destination contract_mock.go
//

// Package version_list_handler is a generated GoMock package.
...
func (m *Mockusecase) Handle(ctx context.Context, in domain.VersionListIn) (*domain.VersionListOut, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Handle", ctx, in)
	ret0, _ := ret[0].(*domain.VersionListOut)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
