...
export interface paths {
    ...
    "/project/update_users/{projectID}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        post: operations["projectUpdateUsers"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/template/create_from_default": {
        ...
        post: operations["templateCreateFromDefault"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/template/default/list": {
        ...
        get: operations["templateDefaultList"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/template/update_users/{templateID}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        post: operations["templateUpdateUsers"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
            ...
            task: {
                ...
                error?: {
                    ...
                    variableErrors?: {
                         ...
                         */
                        id: number;
                        /** @description Слаг переменной */
                        name: string;
                        /** @description Человекочитаемое название переменной */
                        title: string;
                        /** @description Вычисленное значение переменной, на котором сработала проверка ограничений */
                        value?: string;
                        /** @description Сообщение ошибки */
                        message?: string;
                        constraintErrors?: {
        ...
        TemplateCreateFromDefaultRequest: {
            /**
             * Format: int64
             * @description ID библиотечного шаблона-источника
             */
            sourceTemplateID: number;
            /**
             * Format: int64
             * @description ID проекта, в котором будет создан новый шаблон
             */
            projectID: number;
            /** @description Название нового шаблона */
            name: string;
        };
        TemplateCreateFromDefaultResponse: {
            /**
             * Format: int64
        ...
        TemplateDefaultListResponse: {
            /** @description Список библиотечных шаблонов */
            templates: {
                /**
                 * Format: int64
        ...
        TemplateGetByIDVersion: {
            ...
            variables: {
                 ...
                 */
                id: number;
                /** @description Слаг переменной (идентификатор) */
                name: string;
                /** @description Человекочитаемое название переменной */
                title: string;
                /**
        ...
        TemplateUpdateUsersRequest: {
            /** @description Список пользователей шаблона */
            users: {
                /**
                 * Format: int64
                 * @description ID пользователя
                ...
                id: number;
                /**
                 * @description Роль пользователя в шаблоне
                 * @enum {string}
                 */
                role: "read" | "write";
            }[];
...
export interface operations {
    ...
    projectUpdateUsers: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["ProjectUpdateUsersRequest"];
            };
        };
        responses: {
            /** @description No content */
    ...
    projectUsers: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["ProjectUsersResponse"];
                };
            };
            /** @description Bad request */
            400: {
    ...
    templateCreateFromDefault: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["TemplateCreateFromDefaultRequest"];
            };
        };
        responses: {
            /** @description Created */
            201: {
                ...
                content: {
                    "application/json": components["schemas"]["TemplateCreateFromDefaultResponse"];
                };
            };
            /** @description Bad request */
            400: {
    ...
    templateDefaultList: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["TemplateDefaultListResponse"];
                };
            };
            /** @description Bad request */
            400: {
    ...
    templateUpdateUsers: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["TemplateUpdateUsersRequest"];
            };
        };
        responses: {
            /** @description No content */
    ...
    templateUsers: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["TemplateUsersResponse"];
                };
            };
            /** @description Bad request */
            400: {
